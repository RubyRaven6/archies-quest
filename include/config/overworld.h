...
#define OW_WHITEOUT_CUTSCENE            FALSE // In Gen4+, whiting out shows an additional message and post whiteout event script cutscene with a healing NPC. (While this change was also in FRLG, for the sake of simplicity, setting this to GEN_3 will result in RSE behavior.)
...
#define OW_FLAG_NO_COLLISION        FLAG_TEMP_2  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.
