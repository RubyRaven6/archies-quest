...
enum {
    ...
    HEAL_LOCATION_DEMON_LAIRS_MAXIE,
    HEAL_LOCATION_DEMON_LAIRS_NESSIE,
    HEAL_LOCATION_DEMON_LAIRS_ADDISAMAP,
    HEAL_LOCATION_DEMON_LAIRS_GREEHASEET,
    HEAL_LOCATION_DEMON_LAIRS_SAPPRILON,
    HEAL_LOCATION_DEMON_LAIRS_ADDISAMAP_2,
    HEAL_LOCATION_HUB_WORLD_POSTGAME,
    NUM_HEAL_LOCATIONS
};
