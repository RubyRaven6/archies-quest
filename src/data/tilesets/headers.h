...
const struct Tileset gTileset_ArchiesHouse =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_ArchiesHouse,
    .palettes = gTilesetPalettes_ArchiesHouse,
    .metatiles = gMetatiles_ArchiesHouse,
    .metatileAttributes = gMetatileAttributes_ArchiesHouse,
    .callback = NULL,
};
