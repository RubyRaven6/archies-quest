...
const u32 gTrainerFrontPic_Greehaseet[] = INCBIN_U32("graphics/trainers/front_pics/demons/greehaseet.4bpp.smol");
const u16 gTrainerPalette_Greehaseet[] = INCBIN_U16("graphics/trainers/front_pics/demons/greehaseet.gbapal");
...
const u32 gTrainerFrontPic_Archie[] = INCBIN_U32("graphics/trainers/front_pics/cool_archie.4bpp.smol");
const u16 gTrainerPalette_Archie[] = INCBIN_U16("graphics/trainers/front_pics/cool_archie.gbapal");
...
const u8 gTrainerBackPic_CoolArchie[] = INCBIN_U8("graphics/trainers/back_pics/archie.4bpp");
...
const u16 gTrainerBackPicPalette_CoolArchie[] = INCBIN_U16("graphics/trainers/back_pics/archie.gbapal");
...
{
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_BRENDAN, 4, gTrainerBackPic_CoolArchie, gTrainerBackPicPalette_CoolArchie, sBackAnims_Hoenn),
