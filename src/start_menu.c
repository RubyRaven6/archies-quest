...
//static bool8 StartMenuReturnToHubCallback(void);
...
//    [MENU_ACTION_RETURN_HUB]      = {COMPOUND_STRING("Return"), {.u8_void = StartMenuReturnToHubCallback}}
};
...
static bool8 HandleStartMenuInput(void)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        if (gMenuCallback != StartMenuSaveCallback
            ...
            //&& gMenuCallback != StartMenuReturnToHubCallback)
        {
