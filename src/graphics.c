...
const u16 gTitleScreenBgPalettes[]         = INCBIN_U16("graphics/title_screen/pokemon_logo.gbapal",
                                                        ...
                                                        "graphics/title_screen/fire_bg.gbapal");
const u16 gTitleScreenEmeraldVersionPal[]  = INCBIN_U16("graphics/title_screen/archies_quest.gbapal");
//const u16 gTitleScreenMaxieVersionPal[]  = INCBIN_U16("graphics/title_screen/maxies_victory.gbapal");
...
//const u32 gTitleScreenMaxieVersionGfx[]  = INCBIN_U32("graphics/title_screen/maxies_victory.8bpp.lz");
