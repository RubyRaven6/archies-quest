...
const u32 gTitleScreenEmeraldVersionGfx[]  = INCBIN_U32("graphics/title_screen/archies_quest.8bpp.lz");
const u32 gTitleScreenMaxieVersionGfx[]    = INCBIN_U32("graphics/title_screen/archies_demise.8bpp.lz");
